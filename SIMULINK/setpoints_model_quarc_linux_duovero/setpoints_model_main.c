...
typedef RT_MODEL_setpoints_model_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * setpoints_model(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(setpoints_model_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: setpoints_model -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
