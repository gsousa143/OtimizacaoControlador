...
#define rtmGetStepSize(rtm)            (0.01)
#endif
...
typedef RT_MODEL_Fuzzy_manobra_aplica_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Fuzzy_manobra_aplicado_2015b(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Fuzzy_manobra_aplicado_2015b_initialize();
   extern void Fuzzy_manobra_aplicado_2015b_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Fuzzy_manobra_aplicado_2015b_M, GBLbuf.message);
}
...
static void rt_OneStep(RT_MODEL *S)
{
  ...
  Fuzzy_manobra_aplicado_2015b_step();
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "tcpip://192.168.2.24:17001?nagle=no");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Fuzzy_manobra_aplicado_2015b -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  Fuzzy_manobra_aplicado_2015b_initialize();
  S = Fuzzy_manobra_aplicado_2015b_M;
  if (final_time >= 0.0 || final_time == RUN_FOREVER) {
    rtmSetTFinal(S,final_time);
  } else {
    rtmSetTFinal(S,150.0);
  }
  ...
  Fuzzy_manobra_aplicado_2015b_terminate();
